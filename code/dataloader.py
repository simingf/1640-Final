...
def get_dataloader(num_images=10000, batch_size=64, shuffle=True, preprocess_func=None):
    ...
    dataset = RotNetDataset(images, preprocess_func=preprocess_func)
    dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=shuffle)
    return dataloader

if __name__ == "__main__":
    dataloader = get_dataloader(num_images=128)
